...
$queryErb = new WP_Query( array(  'relation' => 'AND',
        'post_type' => 'aw_pp_cats' ,
        'meta_key' => 'aw_pp_cat_state', 'meta_value' => 'erb'  ) );

$numCatsForAudition = $queryNorthfield->have_posts()+$queryElmiraArthur->have_posts()+$queryErb->have_posts();
...
<?php aw_pp_audition_profile($queryErb,"Erb"); ?>
...
<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="258" height="338" title="Click Here to donate!" type="application/x-shockwave-flash"><param name="movie" value="//funds.gofundme.com/Widgetflex.swf" /><param name="quality" value="high" /><param name="flashvars" value="page=petpatroladdition&template=2" /><param name="wmode" value="transparent" /><embed allowScriptAccess="always" src="//funds.gofundme.com/Widgetflex.swf" quality="high" flashVars="page=petpatroladdition&template=2" type="application/x-shockwave-flash" wmode="transparent" width="258" height="338"></embed></object>
